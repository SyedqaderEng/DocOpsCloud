  ...
  return (
    <div className="min-h-screen gradient-animated flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center glass-card">
        ...
        <p className="text-gray-400 mb-6">Something went wrong with authentication.</p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/" className="btn-neon inline-flex items-center justify-center gap-2 px-6 py-3">
