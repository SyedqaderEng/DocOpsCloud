      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Start processing documents for free</p>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 glass-strong border border-[rgba(255,255,255,0.2)] rounded-lg text-white hover:border-[#00d4ff] hover:shadow-[0_0_20px_rgba(0,212,255,0.2)] transition font-medium disabled:opacity-50"
            >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 text-gray-400 glass-strong">or create with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 glass-strong border border-[rgba(255,255,255,0.2)] rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#00d4ff] transition"
                />
                <button
                  type="button"
              ...
              {password && (
                <div className="mt-2 space-y-1">
                  {[
                    ...
                    { check: passwordStrength.hasLower, text: 'One lowercase letter' },
                    { check: passwordStrength.hasNumber, text: 'One number' },
                  ].map((item, i) => (
                    <div key={i} className={`flex items-center gap-2 text-xs ${item.check ? 'text-[#00ff88]' : 'text-gray-500'}`}>
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" required className="mt-1 rounded border-gray-600 bg-transparent" />
